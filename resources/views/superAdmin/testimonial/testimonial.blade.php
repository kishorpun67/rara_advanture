...
@section('content')
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="" data-toggle="modal" data-target="#myModals-add" style="width: auto; float:right; display:inline-block;" class="btn btn-block btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;Add Testimonial</a>
            </div>
            <div class="card-body">
                ...
                <div class="modal fade" id="myModal{{$testimonial->id}}">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        <form  method="POST"   action="{{route('superAdmin.add.edit.testimonial',$testimonial->id)}}"  enctype="multipart/form-data" id="quickFor">
                            @csrf
  ...
  <div class="modal fade" id="myModals-add">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form  method="POST"   action="{{route('superAdmin.add.edit.testimonial')}}"  enctype="multipart/form-data" id="quickForm">
            @csrf
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
